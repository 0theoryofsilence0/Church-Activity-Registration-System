            ...
            >
              ...
              <div>Date/Time: {{
                receipt.camper.created_at
                  ? new Date(receipt.camper.created_at).toLocaleString('en-PH', { 
                      day: '2-digit',
                      month: '2-digit', 
                      year: 'numeric', 
                      hour: '2-digit', 
              ...
              <div>Receipt No: YC-{{ new Date().toISOString().slice(0,10).replace(/-/g,'') }}-{{ String(receipt.camper.id).padStart(3, '0') }}</div>
